...
async function copyChartsToClipboard() {
    try {
        ...
        // Rendre les pixels blancs transparents (fond du graphique)
        const finalCtx = finalCanvas.getContext('2d');
        const imageData = finalCtx.getImageData(0, 0, finalCanvas.width, finalCanvas.height);
        const data = imageData.data;

        // Seuil de tolérance pour détecter le blanc (0-255)
        const whiteThreshold = 250; // Pixels très proches du blanc
        ...
        console.log(`✅ Pixels blancs rendus transparents (fond du graphique)`);
